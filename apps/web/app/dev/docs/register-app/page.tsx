  ...
  return (
    <PageLayout className={styles.layout}>
      ...
      <Steps>
        ...
        <div>Enter the <b>name</b> of your application. The name must be unique and should tell the user what your application is about. The name is shown to the user when authorizing your Application and on their profile und <Link href="/applications">Authorized Applications</Link>.</div>
